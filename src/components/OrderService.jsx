...
function OrderService({ setOpenModal, setSubmitted }) {
    ...
    return (
        <div className="w-[100vw] h-[100vh] bg-white fixed flex justify-center items-center">
            <div className={status ? "w-[900px] h-[600px] rounded-md bg-white flex flex-col p-[25px] shadow-[0_5px_15px_rgba(0,0,0,0.35)]" : "w-[900px] h-[400px] rounded-md bg-white flex flex-col p-[25px] shadow-[0_5px_15px_rgba(0,0,0,0.35)]"}>
                ...
                <div className="flex justify-around">
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            className="mt-1 w-[25rem] h-[3rem] p-5 rounded-md border-gray-200 shadow-sm sm:text-sm border bottom-1"
                        />
                    </div>
                    <div className="flex flex-col">
